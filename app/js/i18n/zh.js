...
export const ZH = {
  ...
  colSegCarve: '刻章铺',
  catMine: '我刻的',
  kzQuotaOwned: '已买断，想刻多少刻多少',
  kzQuotaLeft: '还能免费刻 <b>{n}</b> 枚，之后一次买断 {price}',
  kzQuotaLocal: '免费次数用完了（本地测试版不拦）',
  kzQuotaUsed: '免费的 {n} 枚刻完了 · ',
  kzQuotaUsedBtn: '买断，接着刻 ›',
  kzTitle: '自己刻一枚章',
  kzSub: '一个主体、背景干净、光线亮，最容易刻好看',
  kzTutHint: '三种样子各适合什么，点一组看大图',
  kzShoot: '画一张，拍下来',
  kzAlbum: '从相册选',
  kzResume: '继续刚才那枚「{name}」›',
  kzDefaultName: '我的章',
  kzMineHead: '我刻的章 · {n}',
  kzMineSub: '在托盘里跟别的章一样用',
  kzMineEmpty: '还没有，刻一枚试试',
  kzErrVideo: '刻章只能用照片，不能用视频',
  kzErrNotImage: '这不是照片，请选一张照片',
  kzErrFormat: '这种格式刻不了，换一张普通照片（JPG / PNG）',
  kzErrTooBig: '这张图太大了，换一张，或者先截个图再用',
  kzErrOpen: '这张图打不开，换一张照片试试',
  kzCarvedOn: '「{name}」· {m} 月 {d} 日刻的',
  kzTutPrev: '‹ 上一组',
  kzTutTitle: '什么样的图适合{style}',
  kzClose: '关闭',
  kzTutFit: '{style} · 适合{fit}',
  kzTryShoot: '拍一张试试',
  kzTutNext: '下一组 ›',
  kzCancel: '取消',
  kzCropTitle: '裁一下',
  kzCropHint: '拖动、双指缩放；缩到底能看到整张照片',
  kzCropTip: '东西挤在一起时，裁到只剩你要的那一样，刻出来最清楚',
  kzReselect: '重选',
  kzNext: '下一步',
  kzStyleLine: '线条',
  kzStyleTone: '层次',
  kzStyleSil: '剪影',
  kzTapUndone: '这一下没圈出什么，撤掉了',
  kzHintStyles: '线条＝把图里的线描出来，纸上画的、线清楚的东西最合适。\n层次＝主体内部按明暗分三层叠印，照片想尽量像原图时用。\n剪影＝主体整个填实，只剩外形——只有轮廓本身就认得出的东西才行（一块布、一只鞋、一朵花），圆的方的、要靠里面的字和细节认的（电池、脸、截图）一律不行。',
  kzHintTol: '你点的每一下，往大调会多选进来一些、往小调会少选一些。',
  kzHintDetail: '往少调＝去掉零碎小块，托盘里更干净；往多调＝保留细节，但缩小到托盘里容易糊。',
  kzHintWeight: '托盘 26px 下看不清就往粗调。密线稿加粗会把线缝填死，程序会自己退回去，所以有时候调了变化不大。',
  kzHelp: '说明',
  kzBackCrop: '‹ 重新裁',
  kzPickTitle: '挑一个样子',
  kzWorking: '正在刻出几个样子…',
  kzInTray: '放进托盘里：',
  kzTapAdd: '<b>点你要的部分</b>，亮起来的会刻进去',
  kzTapErase: '<b>点不要的部分</b>，把它去掉',
  kzAddPiece: '加一块',
  kzErasePiece: '去掉一块',
  kzUndo: '撤销',
  kzPickAll: '整张都要',
  ...
  kzTolLab: '每一下的范围',
  kzTolScale: '小一点 · 大一点',
  kzFixAgain: '已经自己修过 · 再修修 ›',
  kzFix: '当前图不满意？点这里可以自己修 ›',
  kzDetail: '细节',
  kzDetailScale: '少 · 多',
  kzWeight: '粗细',
  kzWeightOpts: '原样|细|中|粗',
  kzNoSubject: '没找到主体',
  kzForce: '还是想刻这个 ›',
  kzForced: '好，照这个刻',
  kzBackAdjust: '‹ 返回调整',
  ...
  kzFrameSquare: '方',
  kzRing: '章上的字（可空）',
  kzRingPhCircle: '沿着圆圈排，比如：我家小狗',
  kzRingPhBottom: '写在章下面，比如：我家小狗',
  kzDate: '带上今天的日期 {date}',
  kzInkDefault: '默认印泥',
  kzMineSlot: '放进托盘后在「我刻的」那一格',
  kzToTrial: '刻好了，试盖一下',
  kzTrialFree: '试盖不扣次数 · 满意放进托盘时才算用掉 1 次',
  kzCarving: '正在刻…',
  kzSkip: '点一下跳过',
  kzBackTweak: '‹ 再调调',
  kzTrialTitle: '试盖一下',
  kzDrop: '不要了',
  kzPaperHint: '在纸上点一点，试着盖几下',
  kzInk: '印泥',
  kzWipe: '擦掉',
  kzNameLocked: '名字（放进托盘后就不能改了）',
  kzAsk: '满意吗？放进托盘后，它就跟别的章一样了：<b>不能删，也不能改名</b>。',
  kzTweak: '再调调',
  kzSave: '满意，放进托盘',
  kzAgain: '都不满意？换一张照片 ›',
  kzTrialOwned: '已买断，不计次',
  kzTrialLeft: '会用掉 1 次免费（还剩 {n} 次）',
  kzTrialUsed: '免费的 {n} 枚刻完了，放进托盘前要先买断',
  kzTrialLocal: '本地测试版：不限次数',
  kzDropConfirm: '不要这枚了？不会扣次数。',
  kzBack: '‹ 回去',
  kzAgainTitle: '换一张试试',
  kzGoodPhoto: '这样的照片刻得好',
  kzTip1: '<b>底色要跟东西差得远</b>：浅色的东西放深色布或黑纸上，深色的东西放白纸上。⛔ 最忌讳反光的台面（大理石、玻璃）——东西和台面一样亮的那一侧，线会整条描不出来。',
  kzTip2: '<b>只放一个东西</b>，摆在正中间，占画面三分之一到三分之二。',
  kzTip3: '<b>光要平</b>，别让东西旁边压着一道浓影子。',
  kzTip4: '<b>侧过来拍</b>，别俯拍——俯拍容易把东西拍成一个圆或一个方。',
  kzTip5: '<b>东西挤在一起（花和叶子那种）</b>：先在手机相册里<b>长按主体把它拎出来</b>，存成图片，再回来「从相册换一张」选它——比在这儿裁干净得多。',
  kzReshoot: '重新拍一张',
  kzAlbumAgain: '从相册换一张',
  kzKeep: '还是用刚才那张',
  kzErrData: '这枚章的数据不对，没存上',
  kzErrFull: '手机存储满了，没存上',
  kzBackTrial: '‹ 回试盖',
  kzBackPlain: '‹ 返回',
  kzFreeDone: '免费的 {n} 枚刻完了',
  kzBuyDesc: '买断一次，以后想刻多少刻多少。<br>刻好的章跟别的章一样：不能删，也不能改名。',
  kzBuyBtn: '买断 · ',
  kzNeedLogin: '支付宝付款要先登录。点「买断」会带你去「我的」登录，这枚章先留着，回来接着放进托盘。',
  kzDoneTitle: '刻好了！',
  kzDoneSub: '「{name}」已经放进托盘「我刻的」那一格',
  kzGoStamp: '现在就去今天盖一下',
  kzStay: '回刻章铺',
  kzJNone: '什么都没描出来',
  kzJNoneTip: '换一张背景干净、主体清楚的图',
  kzJBusy: '图里东西太杂，描出来碎成一片',
  kzJBusyTip: '裁得再近一点，只留想刻的东西；照片可以换成「层次」试试',
  kzJDetail: '细节偏多，托盘里会有点糊',
  kzJDetailTip: '裁近一点，或者把「细节」往少调',
  kzJSilBlob: '剪影退化成一整块了，看不出是什么',
  kzJSilBlobTip: '这张图的轮廓不带信息，换「线条」或「层次」；要用剪影得让主体侧过来、背景换成纯色',
  kzJBlock: '变成了一整块，看不出形状',
  kzJBlockTip: '裁近一点重新点主体，或者改用线条',
  kzJFull: '太满了，托盘里看不出细节',
  kzJFullTip: '把「粗细」调细一档，或者裁近一点',
  kzJScatter: '东西太散，拼不成一个图案',
  kzJScatterTip: '裁到只剩一个主体',
  kzJThin: '线太细，托盘里几乎看不见',
  kzJThinTip: '把「粗细」调到中或粗',
  kzJThinish: '线条偏细',
  kzJThinishTip: '把「粗细」调到中',
  kzJPieces: '小块偏多，托盘里会有点糊',
  kzJPiecesTip: '把「细节」往少调一点',
  kzJComplex: '图形太复杂',
  kzJComplexTip: '把「细节」往少调一点，或者裁近一点',
  kzJGood: '托盘里看得清',
  kzHintScreenshot: '这像是一张手机截图，先把想刻的那一块裁出来',
  kzTutLineName: '山水',
  kzTutLineFit: '纸上画的、线条多的',
  kzTutLineWhy: '作者纯手工绘画。手绘、涂鸦、简笔画都属于这一类。程序把纸上的线原样描下来，画得越清楚刻得越好；这张选的是粗细「原样」。',
  kzTutToneName: '花',
  kzTutToneFit: '照片里有明暗、想尽量像原图的',
  kzTutToneWhy: '作者亲自拍摄选材。花、玩偶、有光影的东西都适合。这张背景很杂，先用「当前图不满意？点这里可以自己修」把花点出来，再选层次。',
  kzTutSilName: '苹果',
  kzTutSilFit: '轮廓一看就认得出的实物',
  kzTutSilWhy: '真实苹果桌面摆拍。水果、杯子、鞋、摆件都适合。只留一个影子，所以底色跟东西差得远最好，反光的台面别用。',
