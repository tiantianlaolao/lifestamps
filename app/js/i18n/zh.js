...
export const ZH = {
  ...
  kzJFullTip: '裁近一点，或者把「细节」往少调',
  kzJScatter: '东西太散，拼不成一个图案',
  kzJScatterTip: '裁到只剩一个主体',
  kzJThin: '线太细，托盘里几乎看不见',
  kzJThinTip: '用粗一点的笔重画再拍；照片可以换「层次」或「剪影」',
  kzJThinish: '线条偏细',
  kzJThinishTip: '缩小后可能看不清，笔粗一点会更好',
  ...
  kzTutLineWhy: '作者纯手工绘画。手绘、涂鸦、简笔画都属于这一类。程序把纸上的线原样描下来，画得越清楚刻得越好。',
  kzTutToneName: '花',
